...
const javascript_dev_kit_1 = (0, tslib_1.__importDefault)(require("javascript-dev-kit"));
const ServerConfig_1 = (0, tslib_1.__importDefault)(require("../serverconfig/ServerConfig"));
...
(0, tslib_1.__decorate)([
    (0, mongoose_types_1.Prop)({ type: {}, required: true }),
    (0, tslib_1.__metadata)("design:type", MediaConstraints)
...
Conference = (0, tslib_1.__decorate)([
    (0, mongoose_types_1.Schema)({ timestamps: { createdAt: true } }),
    (0, tslib_1.__metadata)("design:paramtypes", [String, String, String, String, ServerConfig_1.default, Object, Object])
], Conference);
